...
const steps = [
  {
    ...
    body: "Fill in the enquiry form or WhatsApp your travel dates and interests",
  },
  {
    icon: MapPin,
    title: "Get Your Custom Plan",
    body: "I'll design a personalised itinerary within 24 hours",
  },
  {
    icon: CheckCircle2,
    title: "Confirm & Prepare",
    body: "We fine-tune every detail — I handle all logistics",
  },
  {
    icon: PalmtreeIcon,
    title: "Arrive & Explore",
    body: "I meet you at the airport. Your Sri Lanka story begins.",
  },
];
  ...
  return (
    <section className="relative overflow-hidden bg-[var(--jungle-deep)] py-24">
      <div
        ...
        style={{
          backgroundImage: "repeating-linear-gradient(45deg, white 0 1px, transparent 1px 40px)",
        }}
      />
        ...
        <div className="reveal relative grid gap-10 md:grid-cols-4">
          ...
          {steps.map((s, i) => (
            <div key={s.title} className="relative text-center">
              ...
              <h3 className="mt-3 text-xl font-semibold text-white" style={{ color: "white" }}>
                {s.title}
              </h3>
